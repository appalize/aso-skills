...
This repo contains ASO & App Marketing skills following the [Agent Skills](https://agentskills.io) open standard — maintained by [Appalize](https://appalize.com), the enterprise-grade ASO platform.
...
tools/integrations/        — API integration guides (Appalize, Firebase, etc.)
