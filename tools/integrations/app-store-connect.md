...
## When to Use App Store Connect vs Appalize

| Need | App Store Connect | Appalize Connect | Appalize |
|------|------------------|----------------|---------|
...
**Appalize Connect** = connect your ASC API key once in [www.appalize.com → Settings → Integrations](https://www.appalize.com). Data syncs nightly and is then accessible via the Appalize API without repeated ASC auth. See [appalize-connect.md](appalize-connect.md) and the `asc-metrics` skill.
